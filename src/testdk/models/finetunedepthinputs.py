...
class FinetuneDepthInputsTypedDict(TypedDict):
    finetune_id: str
    r"""ID of the fine-tuned model you want to use."""
    prompt: str
    r"""Text prompt for image generation"""
    control_image: str
    r"""Base64 encoded image to use as control input"""
...
class FinetuneDepthInputs(BaseModel):
    finetune_id: str
    r"""ID of the fine-tuned model you want to use."""
    ...
    def serialize_model(self, handler):
        ...
        nullable_fields = ["seed", "output_format", "webhook_url", "webhook_secret"]
        null_default_fields = []
